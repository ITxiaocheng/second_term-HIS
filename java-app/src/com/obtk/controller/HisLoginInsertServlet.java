...
@WebServlet("/HisLogin/insert")
public class HisLoginInsertServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HisLogin hisLogins = new HisLogin(hisLogin.getName(),hisLogin.getIdNumber(),hisLogin.getPhoneNumber(),newPwd, hisLogin.getPermission());
        int i = service.insertReg(hisLogins);
