...
@WebServlet("/HisReg/pageing")
public class HisRegPagingServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //2：调用service查询
        PageBean<HisReg> pb = hisRegService.findStudentByPage(currentPage,pageSize);//得到分页输出结果
